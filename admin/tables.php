...
<form>
<input type="button" value="Individual Member" onclick="window.location.href='individual.php'" />
<input type="button" value="School Member" onclick="window.location.href='school.php'" />
<input type="button" value="Organisation Member" onclick="window.location.href='organisation.php'" />
</form>
<br>
<br>
